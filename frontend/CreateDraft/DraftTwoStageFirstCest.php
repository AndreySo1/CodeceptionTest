...
class DraftTwoStageFirstCest
{
	public function createDraftSuccess(AcceptanceTester $I){
        ...
        $I->submitForm('form', [
		    ...
		    'tenderType' => 'two-stage-first'
		], 'Продолжить');

		$I->waitForText('Создание двухэтапного конкурса', 5, '.page-header');

		$I->seeInTitle('Создание двухэтапного конкурса');
		$I->click('Выбрать');
		...
		$I->fillField(['name' => 'others'], 'ПереченьДоков123'); //иные сведения

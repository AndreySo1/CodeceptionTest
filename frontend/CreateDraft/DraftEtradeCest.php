...
class DraftEtradeCest
{
	public function createDraftSuccess(AcceptanceTester $I){
		...
		$I->waitForText('Создание открытого конкурса (в электронном виде)', 5, '.page-header');

		$I->seeInTitle('Создание открытого конкурса (в электронном виде)');
		$I->click('Выбрать');
